...
public class RectangleAreaTest {
    ...
    public void negativeAndPositive() {
        assertEquals(100, areaCalculator.computeArea(-5, -5, 5, 5, -2, -2, 2, 2));
    }

    @Test
    public void touchingAtCorner() {
        assertEquals(8, areaCalculator.computeArea(0, 0, 2, 2, 2, 2, 4, 4));
    }

    @Test
    public void disjointRectangles() {
        assertEquals(8, areaCalculator.computeArea(0, 0, 2, 2, 10, 10, 12, 12));
    }

    @Test
    public void fullContainment() {
        assertEquals(8, areaCalculator.computeArea(0, 0, 2, 2, 2, 2, 4, 4));
    }

    @Test
    public void partialDiagonalOverlap() {
        assertEquals(28, areaCalculator.computeArea(0, 0, 4, 4, 2, 2, 6, 6));
    }
    // }
}
